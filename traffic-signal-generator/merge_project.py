...
class PythonProjectMerger:
    ...
    def _get_standard_libs(self) -> Set[str]:
        ...
        common_stdlibs = {
            ...
            'unittest', 'tempfile', 'csv', 'io', 'base64', 'hashlib', 'ssl',
            'socket', 'email', 'urllib', 'http', 'xml', 'html', 'configparser',
            'pickle', 'sqlite3', 'zlib', 'gzip', 'bz2', 'zipfile', 'tarfile',
            'ast', 'inspect', 'typing', 'dataclasses', 'enum', 'abc', 'copy',
            'pprint', 'traceback', 'warnings', 'weakref', 'contextlib', 'pymoo', 'concurrent', 'gekko',
